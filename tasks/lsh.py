from cache import get_cache_for_folder_image_features

get_cache_for_folder_image_features = get_cache_for_folder_image_features() #input_folder_path: {'images': , 'image_features':}
